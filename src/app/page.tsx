  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 py-10">
        {/* Hero badge */}
        <div className="mb-4 flex items-center gap-2 rounded-full border border-indigo-400/20 bg-indigo-500/10 px-4 py-1.5 text-xs font-medium text-indigo-600 dark:text-indigo-300 backdrop-blur-sm">
          <LiveDot />
          <span>Live GitHub intelligence</span>
          <span className="text-indigo-400/50 dark:text-indigo-500/50">·</span>
          <span className="text-indigo-500 dark:text-indigo-200">48M+ developers</span>
        </div>
        ...
        <p className="mb-8 max-w-xl text-center text-base text-neutral-500 dark:text-neutral-300 sm:text-lg">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
            {[
              ...
              <button
                ...
                className="rounded-full border border-neutral-300 px-3 py-1.5 text-xs font-medium text-neutral-600 transition-all hover:border-indigo-400/60 hover:text-indigo-600 hover:bg-indigo-500/10 hover:-translate-y-px dark:border-neutral-600/40 dark:text-neutral-300 dark:hover:text-indigo-300"
              >
                {chip.label}
              </button>
            ))}
        ...
        {/* Stats bar */}
        <div className="mt-10 flex items-center gap-8 sm:gap-12 rounded-xl border border-neutral-200 bg-white/80 px-8 py-4 shadow-sm backdrop-blur-sm dark:border-neutral-700/30 dark:bg-neutral-900/50 dark:shadow-none">
          {stats.map((s, i) => (
            <div key={s.label} className="flex items-center gap-2.5">
              <s.icon className="h-4 w-4 text-indigo-500 dark:text-indigo-400" />
              <div>
              ...
              {i < stats.length - 1 && <div className="ml-6 h-8 w-px bg-neutral-200 dark:bg-neutral-700/50 sm:ml-8" />}
            </div>
          ))}
        </div>
